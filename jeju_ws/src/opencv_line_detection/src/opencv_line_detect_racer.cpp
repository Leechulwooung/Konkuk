...
int main(int argc, char **argv)
{
   ...
   int capture_width = 1280 ;		//******************다름****************
   int capture_height = 720 ;		//******************다름****************
   ...
   */
   ...
   { 
     ...
     */
     ...
     line_count = line_center_x = 0.0;			//****************다름
