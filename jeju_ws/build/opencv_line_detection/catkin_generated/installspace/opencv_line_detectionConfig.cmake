...
if(NOT "include;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'opencv_line_detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/amap/jeju_ws/install/lib;/home/amap/jeju_ws/devel/lib;/home/amap/aMAP_catkin_ws/devel/lib;/home/amap/catkin_ws/devel/lib;/opt/ros/melodic/lib)
